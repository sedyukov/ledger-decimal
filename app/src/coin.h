...
#define HDPATH_1_DEFAULT     (0x80000000u | 0x3cu)
...
#define MENU_MAIN_APP_LINE1                "Decimal"
#define MENU_MAIN_APP_LINE2                "Ready"
#define APPVERSION_LINE1                   "Version:"
#define APPVERSION_LINE2                   ("v" APPVERSION)

#define COIN_DEFAULT_CHAINID                "decimal-mainnet-08-01"

// In non-expert mode, the app will convert from del to DEL
#define COIN_DEFAULT_DENOM_BASE             "del"
#define COIN_DEFAULT_DENOM_REPR             "DEL"
#define COIN_DEFAULT_DENOM_FACTOR           18
